...
type Group struct {
	...
	Sport       string      `boil:"sport" json:"sport" toml:"sport" yaml:"sport"`
...
var GroupWhere = struct {
	...
	UUID:        whereHelperstring{field: "\"groups\".\"uuid\""},
	Name:        whereHelperstring{field: "\"groups\".\"name\""},
	Sport:       whereHelperstring{field: "\"groups\".\"sport\""},
	Description: whereHelpernull_String{field: "\"groups\".\"description\""},
	Street:      whereHelpernull_String{field: "\"groups\".\"street\""},
	City:        whereHelpernull_String{field: "\"groups\".\"city\""},
	Country:     whereHelpernull_String{field: "\"groups\".\"country\""},
...
var (
	groupAllColumns            = []string{"uuid", "name", "sport", "description", "street", "city", "country", "created_at", "updated_at"}
	groupColumnsWithoutDefault = []string{"uuid", "name", "sport"}
	groupColumnsWithDefault    = []string{"description", "street", "city", "country", "created_at", "updated_at"}
	groupPrimaryKeyColumns     = []string{"uuid"}
...
func FindGroup(ctx context.Context, exec boil.ContextExecutor, uUID string, selectCols ...string) (*Group, error) {
	groupObj := &Group{}
	...
	query := fmt.Sprintf(
		"select %s from \"groups\" where \"uuid\"=$1", sel,
	)
...
func (o *Group) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindGroup(ctx, exec, o.UUID)
	if err != nil {
		return err
	}
...
func GroupExists(ctx context.Context, exec boil.ContextExecutor, uUID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"groups\" where \"uuid\"=$1 limit 1)"
...
func (o *Group) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return GroupExists(ctx, exec, o.UUID)
}
